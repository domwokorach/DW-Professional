...
export default function CookiesPage() {
  ...
  return (
    <LegalPage title="Cookie Policy">
      ...
      <div>
        <p className="font-medium text-paper">Analytics</p>
        <p>
      ...
      <div>
        <p className="font-medium text-paper">Functional</p>
        <p>Optional. Used to remember preferences and provide enhanced functionality.</p>
      </div>
      <div>
        <p className="font-medium text-paper">Marketing</p>
        <p>Optional. Used for advertising, campaign measurement or remarketing where applicable.</p>
      </div>
      <button
        type="button"
        onClick={openSettings}
        className="mt-2 inline-flex min-h-[48px] items-center gap-2 rounded-full border border-line px-5 py-3 text-sm font-medium text-paper transition-colors hover:border-accent/60"
      >
