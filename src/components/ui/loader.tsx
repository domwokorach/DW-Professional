    ...
    <div className={cn("relative", sizeClasses[size], className)}>
      <div className="absolute h-full w-full">
        {[...Array(12)].map((_, i) => (
          <div
            key={i}
            className="absolute animate-[spinner-fade_1.2s_linear_infinite] rounded-full bg-muted"
            style={{
              top: "0",
              left: "50%",
...
export function PulseLoader({
  ...
  return (
    <div className={cn("relative", sizeClasses[size], className)}>
      <div className="absolute inset-0 animate-[thin-pulse_1.5s_ease-in-out_infinite] rounded-full border-2 border-muted" />
      <span className="sr-only">Loading</span>
    </div>
  );
}
...
export function PulseDotLoader({
  ...
  return (
    <div
      className={cn(
        "animate-[pulse-dot_1.2s_ease-in-out_infinite] rounded-full bg-muted",
        sizeClasses[size],
        className
      )}
    >
  ...
  return (
    <div className={cn("flex items-center space-x-1", containerSizes[size], className)}>
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className={cn("animate-[bounce-dots_1.4s_ease-in-out_infinite] rounded-full bg-muted", dotSizes[size])}
  ...
  return (
    <div className={cn("flex items-center space-x-1", containerSizes[size], className)}>
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className={cn("animate-[typing_1s_infinite] rounded-full bg-muted", dotSizes[size])}
  ...
  return (
    <div className={cn("flex items-center gap-0.5", containerSizes[size], className)}>
      {[...Array(5)].map((_, i) => (
        <div
          key={i}
          className={cn("animate-[wave_1s_ease-in-out_infinite] rounded-full bg-muted", barWidths[size])}
  ...
  return (
    <div className={cn("flex", containerSizes[size], className)}>
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className={cn("h-full animate-[wave-bars_1.2s_ease-in-out_infinite] bg-muted", barWidths[size])}
...
export function TextShimmerLoader({
  ...
  return (
    <div
      className={cn(
        "bg-[linear-gradient(to_right,#a3a3a3_40%,#ffffff_60%,#a3a3a3_80%)] bg-[length:200%_auto] bg-clip-text font-medium text-transparent",
