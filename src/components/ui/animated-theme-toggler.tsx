...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      if (isControlled) {
        // The parent (e.g. next-themes) owns the DOM attribute/class that
        // actually switches the theme; toggling our own class here would
        // create a second, conflicting theme state.
        onThemeChange?.(newTheme ? "dark" : "light")
      } else {
        // Toggle synchronously so the View Transitions API snapshots the
        // new theme inside the startViewTransition callback.
