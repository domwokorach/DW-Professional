...
export function LogoTimeline({
  ...
  return (
    <section className={cn("w-full", height, className)}>
      <motion.div
        aria-hidden="true"
        className="bg-oklch(1 0 0) relative h-full w-full overflow-hidden py-24 ring-inset sm:py-32 dark:bg-oklch(0.145 0 0)"
        ...
        {title && (
          <div className="absolute top-1/2 left-1/2 mx-auto w-full max-w-[90%] -translate-x-1/2 -translate-y-1/2 text-center">
            <div className="relative z-10">
              <p className="text-oklch(0.145 0 0)/10 mx-auto mt-2 max-w-3xl text-4xl font-semibold tracking-tight text-pretty sm:text-5xl md:text-6xl dark:text-oklch(0.985 0 0)/10">
                {title}
              </p>
            </div>
          </div>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      "from-secondary/50 to-secondary/50 ring-oklch(1 0 0)/10 dark:ring-oklch(0.145 0 0)/10 rounded-full bg-gradient-to-t from-50% ring-1 backdrop-blur-sm ring-inset dark:ring-oklch(0.145 0 0)/10 dark:dark:ring-oklch(0.985 0 0)/10",
                  ...
                  >
                    {IconComponent}
                    <span className="text-oklch(0.145 0 0) text-sm/6 font-medium dark:text-oklch(0.985 0 0)">
                      {logo.label}
                    </span>
                  </div>
                )
