  ...
  return (
    ...
    >
      <div
        onClick={handleClick}
        className={cn(
          "cursor-text rounded-2xl border border-line bg-ink p-2 shadow-none",
...
function PromptInputTextarea({ className, onKeyDown, disableAutosize = false, ...props }: PromptInputTextareaProps) {
  ...
  return (
    <Textarea
      ...
      className={cn(
        "min-h-[44px] w-full resize-none border-none bg-transparent text-white shadow-none outline-none focus-visible:outline-none",
        className
      )}
      rows={1}
      disabled={disabled}
