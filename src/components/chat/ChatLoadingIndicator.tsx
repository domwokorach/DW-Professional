 ...
 * response, etc). Wraps the Magic UI Ripple primitive with a fixed,
 * clipped size so it never grows the message bubble, a static dot
 * fallback for `prefers-reduced-motion` (the Ripple's SMIL `<animate>`
 * tags ignore the CSS animation-duration override in globals.css), and
