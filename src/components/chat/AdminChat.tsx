  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden">
      ...
      <SidebarProvider className="contents">
        <div className="min-h-0 flex-1 md:grid md:grid-cols-[260px_1fr] lg:grid-cols-[300px_1fr] xl:grid-cols-[320px_1fr]">
          <ConversationList
          ...
          <div className={`min-w-0 lg:grid lg:grid-cols-[1fr_320px] xl:grid-cols-[1fr_360px] ${selectedId ? "grid" : "hidden md:grid"}`}>
