...
function TooltipContent({
  ...
  return (
    <TooltipContentPrimitive
      className={cn(
        'z-50 w-fit bg-surface text-white rounded-md dark:bg-surface dark:text-white',
        className,
      )}
      {...props}
    >
      ...
      <TooltipArrowPrimitive
        className="fill-surface size-3 data-[side='bottom']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  );
